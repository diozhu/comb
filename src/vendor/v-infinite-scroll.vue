<template>
    <div class="v-infinite-scroll" @touchstart.stop @touchmove.stop @touchend.stop>
        <v-scroll ref="scroll" v-model="currentValue" :func="getList" func-type="section" :enabled="enabled"
                  :scrollDistance="scrollDistance" :tombstone="tombstone">
            ...
            >
                ...
                >
                    ...
                    <li v-for="(item, idx) in listVisible" :key="idx"
...
import _ from '../../static/js/vendor/underscore.min.js';
