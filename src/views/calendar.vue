        ...
        <div class="page page-calendar">
            ...
            >
                ...
                <template slot="day-content" slot-scope="props">
                    <div class="day-item" v-if="props.data.datas && props.data.datas.length" v-for="(item, index) in props.data.datas" :key="index">
                        <p>{{item.time}}</p>
                        <!--<p>{{item.name}}</p>-->
                ...
                <template slot="week-content" slot-scope="props">
                    <div class="week-item" v-if="props.data && props.data.length" v-for="(item, index) in props.data" :key="index">
                        <p>{{item.time}}</p>
...
export default {
    ...
    methods: {
        ...
        getList () { // 监听日期变化，重新获取列表数据
            this.$logger.log('calendar.getList.start: ');
