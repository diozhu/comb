            ...
            <ul class="comment-list">
                <li v-for="(item, idx) in listData" :id="'commentLi'+idx" class="height-auto">
                    ...
                    <p-comments-reply v-if="replyMode" v-model="item.replies" :detail="item.comment" :total-show="true" :limit="5">
                        <!--<router-link :to="{ name: 'comment-info-replies', params: { id: comment.Id } }" tag="p" slot="total">查看全部评价 ></router-link>-->
...
<script type="text/ecmascript-6">
    ...
    import vSwipeLabel from '../../src/vendor/v-swipe-label.vue';
    import pCommentsBtn from './p-comments-btn.vue';
    import { mapState } from 'vuex'; //eslint-disable-line
    import pCommentsReply from './p-comments-reply.vue';
